            ...
            <div class="container">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-6">
                            <input type="text" id="#editor" class="form-control" name="title" value="<?php echo $post['title']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="content" rows="20" required><?php echo $post['content']; ?></textarea>
                    </div>
                    <div class="form-group">
